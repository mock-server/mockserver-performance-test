...
runCommand "locust --loglevel=INFO --no-web --only-summary --csv=200c_noTLS -c 1500 -r 150 -n 500000 --host=http://$MOCKSERVER_HOST"
runCommand "locust --loglevel=INFO --no-web --only-summary --csv=200c_noTLS -c 2000 -r 200 -n 500000 --host=http://$MOCKSERVER_HOST"
runCommand "locust --loglevel=INFO --no-web --only-summary --csv=200c_noTLS -c 2500 -r 250 -n 500000 --host=http://$MOCKSERVER_HOST"
runCommand "locust --loglevel=INFO --no-web --only-summary --csv=200c_noTLS -c 3000 -r 300 -n 500000 --host=http://$MOCKSERVER_HOST"
runCommand "locust --loglevel=INFO --no-web --only-summary --csv=200c_noTLS -c 3500 -r 350 -n 500000 --host=http://$MOCKSERVER_HOST"
runCommand "locust --loglevel=INFO --no-web --only-summary --csv=200c_noTLS -c 4000 -r 400 -n 500000 --host=http://$MOCKSERVER_HOST"
runCommand "locust --loglevel=INFO --no-web --only-summary --csv=200c_noTLS -c 4500 -r 450 -n 500000 --host=http://$MOCKSERVER_HOST"
runCommand "locust --loglevel=INFO --no-web --only-summary --csv=200c_noTLS -c 5000 -r 500 -n 500000 --host=http://$MOCKSERVER_HOST"
runCommand "locust --loglevel=INFO --no-web --only-summary --csv=200c_noTLS -c 5500 -r 550 -n 500000 --host=http://$MOCKSERVER_HOST"
runCommand "locust --loglevel=INFO --no-web --only-summary --csv=200c_noTLS -c 6000 -r 600 -n 500000 --host=http://$MOCKSERVER_HOST"